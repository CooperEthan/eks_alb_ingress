...
spec:
  type: ExternalName
  externalName: usermgmt.cn5bvz5a3qyf.eu-west-1.rds.amazonaws.com
```
 - **Deploy Manifest**
```
...
```
kubectl run -it --rm --image=mysql:5.7.22 --restart=Never mysql-client -- mysql -h usermgmt.cn5bvz5a3qyf.eu-west-1.rds.amazonaws.com -u dbadmin -pdbpassword11
